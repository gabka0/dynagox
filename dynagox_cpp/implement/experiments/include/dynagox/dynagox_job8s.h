#ifndef DYNAGOX_DYNAGOX_JOB8S_H
#define DYNAGOX_DYNAGOX_JOB8S_H
...
class DynaGoxJOB8s : public DynaGoxBase {
private:
...
public:
  explicit DynaGoxJOB8s(std::ostream &output, bool print_result, double b)
