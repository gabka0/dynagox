#ifndef DYNAGOX_DYNAGOX_JOB8M1_H
#define DYNAGOX_DYNAGOX_JOB8M1_H
...
class DynaGoxJOB8m1 : public DynaGoxBase {
private:
...
public:
  explicit DynaGoxJOB8m1(std::ostream &output, bool print_result, double b)
