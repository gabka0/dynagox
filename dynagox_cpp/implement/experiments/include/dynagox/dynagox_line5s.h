#ifndef DYNAGOX_DYNAGOX_LINE5S_H
#define DYNAGOX_DYNAGOX_LINE5S_H
...
class DynaGoxLine5s : public DynaGoxBase {
private:
...
public:
  explicit DynaGoxLine5s(std::ostream &output, bool print_result, double b)
