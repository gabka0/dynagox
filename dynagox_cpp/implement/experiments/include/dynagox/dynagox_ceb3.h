#ifndef DYNAGOX_DYNAGOX_CEB3_H
#define DYNAGOX_DYNAGOX_CEB3_H
...
class DynaGoxCEB3 : public DynaGoxBase {
private:
...
public:
  explicit DynaGoxCEB3(std::ostream &output, bool print_result, double b)
