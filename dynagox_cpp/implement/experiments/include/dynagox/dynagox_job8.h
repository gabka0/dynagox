#ifndef DYNAGOX_DYNAGOX_JOB8_H
#define DYNAGOX_DYNAGOX_JOB8_H
...
class DynaGoxJOB8 : public DynaGoxBase {
private:
...
public:
  explicit DynaGoxJOB8(std::ostream &output, bool print_result, double b)
