#ifndef DYNAGOX_DYNAGOX_LINE5GC_H
#define DYNAGOX_DYNAGOX_LINE5GC_H
...
class DynaGoxLine5gc : public DynaGoxBase {
private:
...
public:
  explicit DynaGoxLine5gc(std::ostream &output, bool print_result, double b,
                          bool delta_mode)
