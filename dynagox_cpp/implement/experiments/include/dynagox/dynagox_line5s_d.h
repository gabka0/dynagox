#ifndef DYNAGOX_DYNAGOX_LINE5S_D_H
#define DYNAGOX_DYNAGOX_LINE5S_D_H
...
class DynaGoxLine5sd : public DynaGoxBase {
private:
...
public:
  explicit DynaGoxLine5sd(std::ostream &output, bool print_result, double b)
