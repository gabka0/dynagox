#ifndef DYNAGOX_DYNAGOX_LINE5CD_H
#define DYNAGOX_DYNAGOX_LINE5CD_H
...
class DynaGoxLine5cd : public DynaGoxBase {
private:
...
public:
  explicit DynaGoxLine5cd(std::ostream &output, bool print_result, double b)
