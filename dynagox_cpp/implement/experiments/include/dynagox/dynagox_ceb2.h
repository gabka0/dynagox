#ifndef DYNAGOX_DYNAGOX_CEB2_H
#define DYNAGOX_DYNAGOX_CEB2_H
...
class DynaGoxCEB2 : public DynaGoxBase {
private:
  ...
  MultiHashMap<Tuple1, PrimaryHashIndex<Tuple1, Tuple1Hash, Tuple1Equal>> apv_mc;
...
public:
  explicit DynaGoxCEB2(std::ostream &output, bool print_result, double b)
