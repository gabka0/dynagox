#ifndef DYNAGOX_DYNAGOX_TPCDS19_H
#define DYNAGOX_DYNAGOX_TPCDS19_H
...
class DynaGoxTPCDS19 : public DynaGoxBase {
private:
  ...
  MultiHashMap<CustomerJoinKeyTPCDS19, PrimaryHashIndex<CustomerJoinKeyTPCDS19, CustomerJoinKeyTPCDS19Hash,
      CustomerJoinKeyTPCDS19Equal>> apv_c;
  ...
  MultiHashMap<GStoreSalesTPCDS19, PrimaryHashIndex<GStoreSalesTPCDS19, GStoreSalesTPCDS19Hash, GStoreSalesTPCDS19Equal>> hv_gss;

public:
  explicit DynaGoxTPCDS19(std::ostream &output, bool print_result, double b, bool delta_mode)
