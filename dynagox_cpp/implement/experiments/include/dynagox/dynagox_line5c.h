#ifndef DYNAGOX_DYNAGOX_LINE5C_H
#define DYNAGOX_DYNAGOX_LINE5C_H
...
class DynaGoxLine5c : public DynaGoxBase {
private:
...
public:
  explicit DynaGoxLine5c(std::ostream &output, bool print_result, double b)
