#ifndef DYNAGOX_DYNAGOX_JOB19_H
#define DYNAGOX_DYNAGOX_JOB19_H
...
class DynaGoxJOB19 : public DynaGoxBase {
private:
...
public:
  explicit DynaGoxJOB19(std::ostream &output, bool print_result, double b)
