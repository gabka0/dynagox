#ifndef DYNAGOX_DYNAGOX_TPCH8_H
#define DYNAGOX_DYNAGOX_TPCH8_H
...
class DynaGoxTPCH8 : public DynaGoxBase {
private:
  ...
  inline void update_activate_apv_c(unsigned long c_custkey);

  inline void update_activate_r_o(unsigned long o_orderkey, unsigned long o_custkey, unsigned long o_year);

  inline void update_activate_apv_o(unsigned long o_orderkey, unsigned long o_year);

  inline void update_activate_r_l(unsigned long l_orderkey, unsigned long l_partkey, unsigned long l_suppkey,
                                  unsigned long l_linenumber, double l_extendedprice, double l_discount);

  inline double update_add_approx_apv_l1(unsigned long l_orderkey, double value);

  inline double update_add_approx_apv_l2(unsigned long l_orderkey, double value);

  inline void update_activate_r_n1(unsigned long n_nationkey, unsigned long n_regionkey);

  inline void update_activate_apv_n1(unsigned long n_nationkey);
  ...
  inline void update_add_hv_go1(unsigned long o_year, double value);

  inline void update_add_hv_go2(unsigned long o_year, double value);
  ...
  MultiHashMap<SupplierJoinKeyTPCH8, PrimaryHashIndex<SupplierJoinKeyTPCH8, SupplierJoinKeyTPCH8Hash,
      SupplierJoinKeyTPCH8Equal>> apv_s;
  ...
  MultiHashMap<CustomerJoinKeyTPCH8, PrimaryHashIndex<CustomerJoinKeyTPCH8, CustomerJoinKeyTPCH8Hash,
      CustomerJoinKeyTPCH8Equal>> apv_c;
  ...
  MultiHashMap<LineitemJoinKeyTPCH8, PrimaryHashIndex<LineitemJoinKeyTPCH8, LineitemJoinKeyTPCH8Hash,
      LineitemJoinKeyTPCH8Equal>> apv_l1;
  MultiHashMap<LineitemJoinKeyTPCH8, PrimaryHashIndex<LineitemJoinKeyTPCH8, LineitemJoinKeyTPCH8Hash,
      LineitemJoinKeyTPCH8Equal>> apv_l2;
  ...
  MultiHashMap<Nation1JoinKeyTPCH8, PrimaryHashIndex<Nation1JoinKeyTPCH8, Nation1JoinKeyTPCH8Hash,
      Nation1JoinKeyTPCH8Equal>> apv_n1;
  ...
  MultiHashMap<GOrdersTPCH8, PrimaryHashIndex<GOrdersTPCH8, GOrdersTPCH8Hash, GOrdersTPCH8Equal>> hv_go1;

  MultiHashMap<GOrdersTPCH8, PrimaryHashIndex<GOrdersTPCH8, GOrdersTPCH8Hash, GOrdersTPCH8Equal>> hv_go2;

public:
  explicit DynaGoxTPCH8(std::ostream &output, bool print_result, double b, bool delta_mode)
