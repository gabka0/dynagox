#ifndef DYNAGOX_CROWN_LINE5CD_H
#define DYNAGOX_CROWN_LINE5CD_H
...
class CrownLine5cd : public CrownBase {
private:
...
public:
  explicit CrownLine5cd(std::ostream &output, bool print_result)
