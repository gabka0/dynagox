#ifndef DYNAGOX_CROWN_LINE5S_D_H
#define DYNAGOX_CROWN_LINE5S_D_H
...
class CrownLine5sd : public CrownBase {
private:
...
public:
  explicit CrownLine5sd(std::ostream &output, bool print_result)
