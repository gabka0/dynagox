#ifndef DYNAGOX_CROWN_CEB4_H
#define DYNAGOX_CROWN_CEB4_H
...
class CrownCEB4 : public CrownBase {
private:
  ...
  MultiHashMap<Tuple1, PrimaryHashIndex<Tuple1, Tuple1Hash, Tuple1Equal>> pv_mk;

  MultiHashMap<Tuple1, PrimaryHashIndex<Tuple1, Tuple1Hash, Tuple1Equal>> pv_pi;

public:
  explicit CrownCEB4(std::ostream &output, bool print_result) : CrownBase(output, print_result), result(0) {}
