#ifndef DYNAGOX_CROWN_CEB1_H
#define DYNAGOX_CROWN_CEB1_H
...
class CrownCEB1 : public CrownBase {
private:
...
public:
  explicit CrownCEB1(std::ostream &output, bool print_result) : CrownBase(output, print_result), result(0) {}
