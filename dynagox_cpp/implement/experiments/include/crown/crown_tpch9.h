#ifndef DYNAGOX_CROWN_TPCH9_H
#define DYNAGOX_CROWN_TPCH9_H
...
class CrownTPCH9 : public CrownBase {
private:
  ...
  inline void update_add_sv_gl1(const std::string &n_name, unsigned long o_year, double value);

  inline void update_add_sv_gl2(const std::string &n_name, unsigned long o_year, double value);
  ...
  MultiHashMap<SupplierJoinKeyTPCH9, PrimaryHashIndex<SupplierJoinKeyTPCH9, SupplierJoinKeyTPCH9Hash,
      SupplierJoinKeyTPCH9Equal>> pv_s;
  ...
  MultiHashMap<GLineitemTPCH9, PrimaryHashIndex<GLineitemTPCH9, GLineitemTPCH9Hash, GLineitemTPCH9Equal>> sv_gl1;

  MultiHashMap<GLineitemTPCH9, PrimaryHashIndex<GLineitemTPCH9, GLineitemTPCH9Hash, GLineitemTPCH9Equal>> sv_gl2;

public:
  explicit CrownTPCH9(std::ostream &output, bool print_result, bool delta_mode) : CrownBase(output, print_result),
