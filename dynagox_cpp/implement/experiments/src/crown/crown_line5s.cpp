...
void CrownLine5s::process(const std::string &line) {
...
void CrownLine5s::milestone() { print(); }

void CrownLine5s::insert_into_r1(unsigned long src, unsigned long dst) {
  r1k.f0 = dst;
...
void CrownLine5s::insert_into_r2(unsigned long src, unsigned long dst) {
  r2t.f0 = src;
  r2t.f1 = dst;
  r2.update_add(r2t, 1);
...
void CrownLine5s::insert_into_r3(unsigned long src, unsigned long dst) {
  r3t.f0 = src;
  r3t.f1 = dst;
  r3.update_add(r3t, 1);
...
void CrownLine5s::insert_into_r4(unsigned long src, unsigned long dst) {
  r4t.f0 = src;
  r4t.f1 = dst;
  r4.update_add(r4t, 1);
...
void CrownLine5s::insert_into_r5(unsigned long src, unsigned long dst) {
  r5k.f0 = src;
