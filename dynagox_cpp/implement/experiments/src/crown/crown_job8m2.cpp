...
void CrownJOB8m2::process(const std::string &line) {
...
void CrownJOB8m2::milestone() { print(); }

void CrownJOB8m2::insert_into_an(unsigned long id, unsigned long person_id) {
  ank.f0 = person_id;
...
void CrownJOB8m2::insert_into_ci(unsigned long id, unsigned long person_id,
...
void CrownJOB8m2::insert_into_mc(unsigned long id, unsigned long movie_id) {
  mck.f0 = movie_id;
