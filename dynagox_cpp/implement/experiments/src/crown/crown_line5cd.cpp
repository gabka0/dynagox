...
void CrownLine5cd::process(const std::string &line) {
...
void CrownLine5cd::milestone() { print(); }

void CrownLine5cd::insert_into_r1(unsigned long src, unsigned long dst) {
  r1k.f0 = dst;
  bool updated_pv_r1 = pv_r1.update_activate(r1k);
  if (updated_pv_r1) {
    r2t.f0 = dst;
...
void CrownLine5cd::insert_into_r2(unsigned long src, unsigned long dst) {
  r2t.f0 = src;
  r2t.f1 = dst;
  r2.update_add(r2t, 1);
...
void CrownLine5cd::insert_into_r3(unsigned long src, unsigned long dst) {
  r3t.f0 = src;
  r3t.f1 = dst;
  r3.update_add(r3t, 1);
...
void CrownLine5cd::insert_into_r4(unsigned long src, unsigned long dst) {
  r4t.f0 = src;
  r4t.f1 = dst;
  r4.update_add(r4t, 1);
  ...
  if (k5 != nullptr) {
    ...
    while (tuple_r3 != nullptr) {
      ...
      pv_r3.update_add(r3k, 1);

      r2k.f0 = tuple_r3->object->f0;
      auto k2 = pv_r2.get(r2k);
      if (k2 != nullptr) {
        result += (k2->annotation);
      }
...
void CrownLine5cd::insert_into_r5(unsigned long src, unsigned long dst) {
  r5k.f0 = src;
  bool updated_pv_r5 = pv_r5.update_activate(r5k);
  if (updated_pv_r5) {
    delta_pv_r4s.clear();
    r4t.f1 = src;
