...
void DynaGoxTPCDS19::process(const std::string &line) {
...
void DynaGoxTPCDS19::milestone() {
  if (!delta_mode) {
    auto gk_gss = hv_gss.get_keys();
...
void DynaGoxTPCDS19::insert_into_store_sales(unsigned long ss_sold_date_sk, unsigned long ss_item_sk,
...
void DynaGoxTPCDS19::insert_into_store(unsigned long s_store_sk) {
...
void DynaGoxTPCDS19::insert_into_customer(unsigned long c_customer_sk, unsigned long c_current_addr_sk) {
...
void DynaGoxTPCDS19::insert_into_customer_address(unsigned long ca_address_sk) {
...
void DynaGoxTPCDS19::insert_into_date_dim(unsigned long d_date_sk) {
...
void DynaGoxTPCDS19::insert_into_item(unsigned long i_item_sk, unsigned long i_brand_id, const std::string &i_brand,
...
void DynaGoxTPCDS19::print(unsigned long i_brand_id, const std::string &i_brand, unsigned long i_manufact_id,
