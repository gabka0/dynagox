...
void DynaGoxLine5cd::process(const std::string &line) {
...
void DynaGoxLine5cd::milestone() { print(); }

inline void DynaGoxLine5cd::insert_into_r1(unsigned long src,
                                           unsigned long dst) {
  r1k.f0 = dst;
  bool updated_pv_r1 = apv_r1.update_activate(r1k);
  if (updated_pv_r1) {
    r2t.f0 = dst;
    auto tuple_r2 = r2.find(0, r2t);
    while (tuple_r2 != nullptr) {
      r2k.f0 = tuple_r2->object->f1;
      apv_r2.update_add(r2k, 1);
...
inline void DynaGoxLine5cd::insert_into_r2(unsigned long src,
                                           unsigned long dst) {
  r2t.f0 = src;
  r2t.f1 = dst;
  r2.update_add(r2t, 1);
...
inline void DynaGoxLine5cd::insert_into_r3(unsigned long src,
                                           unsigned long dst) {
  r3t.f0 = src;
  r3t.f1 = dst;
  r3.update_add(r3t, 1);
...
inline void DynaGoxLine5cd::insert_into_r4(unsigned long src,
                                           unsigned long dst) {
  r4t.f0 = src;
  r4t.f1 = dst;
  r4.update_add(r4t, 1);
  ...
  if (k5 != nullptr) {
    r4k.f0 = src;
    auto delta_pv_r4 = apv_r4.update_add_approx(r4k, 1, b);
    if (delta_pv_r4 != 0) {
      r3t.f1 = src;
...
inline void DynaGoxLine5cd::insert_into_r5(unsigned long src,
                                           unsigned long dst) {
  r5k.f0 = src;
  auto updated_pv_r5 = apv_r5.update_activate(r5k);
  if (updated_pv_r5) {
    delta_pv_r4s.clear();
    r4t.f1 = src;
