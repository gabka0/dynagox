...
void DynaGoxLine5s::process(const std::string &line) {
...
void DynaGoxLine5s::milestone() { print(); }

inline void DynaGoxLine5s::insert_into_r1(unsigned long src,
                                          unsigned long dst) {
  r1k.f0 = dst;
  double delta_pv_r1 =
      apv_r1.update_add_approx(r1k, static_cast<double>(src), b);
  if (delta_pv_r1 != 0) {
    r2t.f0 = dst;
...
inline void DynaGoxLine5s::insert_into_r2(unsigned long src,
                                          unsigned long dst) {
  r2t.f0 = src;
  r2t.f1 = dst;
  r2.update_add(r2t, 1);
...
inline void DynaGoxLine5s::insert_into_r3(unsigned long src,
                                          unsigned long dst) {
  r3t.f0 = src;
  r3t.f1 = dst;
  r3.update_add(r3t, 1);
...
inline void DynaGoxLine5s::insert_into_r4(unsigned long src,
                                          unsigned long dst) {
  r4t.f0 = src;
  r4t.f1 = dst;
  r4.update_add(r4t, 1);
...
inline void DynaGoxLine5s::insert_into_r5(unsigned long src,
                                          unsigned long dst) {
  r5k.f0 = src;
