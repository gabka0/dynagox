...
void DynaGoxTPCH9::process(const std::string &line) {
...
void DynaGoxTPCH9::milestone() {
  if (!delta_mode) {
    auto gk_gl1 = hv_gl1.get_keys();
...
void DynaGoxTPCH9::insert_into_part(unsigned long p_partkey, const std::string &p_name) {
...
void DynaGoxTPCH9::insert_into_supplier(unsigned long s_suppkey, unsigned long s_nationkey) {
...
void DynaGoxTPCH9::insert_into_partsupp(unsigned long ps_partkey, unsigned long ps_suppkey, double ps_supplycost) {
...
void DynaGoxTPCH9::insert_into_orders(unsigned long o_orderkey, unsigned long o_year) {
...
void DynaGoxTPCH9::insert_into_lineitem(unsigned long l_orderkey, unsigned long l_partkey, unsigned long l_suppkey,
...
void DynaGoxTPCH9::insert_into_nation(unsigned long n_nationkey, const std::string &n_name) {
...
void DynaGoxTPCH9::print(const std::string &n_name, unsigned long o_year, double value1, double value2) {
  if (print_result) {
    fmt::println(output, "({},{}) -> ({:.4f},{:.4f})", n_name, o_year, value1, value2);
  }
}

void DynaGoxTPCH9::update_activate_r_p(unsigned long p_partkey) {
  t_p.p_partkey = p_partkey;
  r_p.update_activate(t_p);
}

void DynaGoxTPCH9::update_activate_r_s(unsigned long s_suppkey, unsigned long s_nationkey) {
  t_s.s_suppkey = s_suppkey;
  t_s.s_nationkey = s_nationkey;
  r_s.update_activate(t_s);
}

void DynaGoxTPCH9::update_activate_apv_s(unsigned long s_suppkey, const std::string &n_name) {
  k_s.s_suppkey = s_suppkey;
  k_s.n_name = n_name;
  apv_s.update_activate(k_s);
}

void DynaGoxTPCH9::update_activate_r_ps(unsigned long ps_partkey, unsigned long ps_suppkey, double ps_supplycost) {
...
void DynaGoxTPCH9::update_activate_r_o(unsigned long o_orderkey, unsigned long o_year) {
  t_o.o_orderkey = o_orderkey;
  t_o.o_year = o_year;
  r_o.update_activate(t_o);
}

void DynaGoxTPCH9::update_activate_r_l(unsigned long l_orderkey, unsigned long l_partkey, unsigned long l_suppkey,
                                       unsigned long l_linenumber, double l_quantity, double l_extendedprice,
                                       double l_discount) {
...
void DynaGoxTPCH9::update_activate_r_n(unsigned long n_nationkey, const std::string &n_name) {
  t_n.n_nationkey = n_nationkey;
  t_n.n_name = n_name;
  r_n.update_activate(t_n);
}

void DynaGoxTPCH9::update_add_hv_gl1(const std::string &n_name, unsigned long o_year, double value) {
  t_gl.n_name = n_name;
  t_gl.o_year = o_year;
  hv_gl1.update_add(t_gl, value);
}

void DynaGoxTPCH9::update_add_hv_gl2(const std::string &n_name, unsigned long o_year, double value) {
  t_gl.n_name = n_name;
  t_gl.o_year = o_year;
