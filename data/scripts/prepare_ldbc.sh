...
mkdir -p "${DATA_PATH}/ldbc"

echo "Downloading spark-3.2.2-bin-hadoop3.2..."
rm -rf "${DATA_PATH}/ldbc/spark-3.2.2-bin-hadoop3.2.tgz"
rm -rf "${DATA_PATH}/ldbc/spark-3.2.2-bin-hadoop3.2"
cd "${DATA_PATH}/ldbc"
wget https://archive.apache.org/dist/spark/spark-3.2.2/spark-3.2.2-bin-hadoop3.2.tgz
tar -zxvf spark-3.2.2-bin-hadoop3.2.tgz
rm -rf "${DATA_PATH}/ldbc/spark-3.2.2-bin-hadoop3.2.tgz"
SPARK_PATH="${DATA_PATH}/ldbc/spark-3.2.2-bin-hadoop3.2"

echo "Downloading ldbc_snb_datagen_spark..."
rm -rf "${DATA_PATH}/ldbc/ldbc_snb_datagen_spark"
cd "${DATA_PATH}/ldbc"
git clone git@github.com:ldbc/ldbc_snb_datagen_spark.git
DATAGEN_PATH="${DATA_PATH}/ldbc/ldbc_snb_datagen_spark"
...
rm -rf "${DATA_PATH}/ldbc/Person_knows_Person/"
rm -rf "${DATA_PATH}/ldbc/Person_hasInterest_Tag/"
mv "${DYNAMIC_PATH}/Person_knows_Person/" "${DATA_PATH}/ldbc/"
mv "${DYNAMIC_PATH}/Person_hasInterest_Tag/" "${DATA_PATH}/ldbc/"
