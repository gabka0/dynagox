...
public class DynaGoxJOB16 extends DynaGoxJOB {
    public DynaGoxJOB16(double epsilon, boolean print) {
    ...
    public void insert_into_cast_info(int personId, int movieId) {
        ...
        if (g_mc != null) {
            ...
            if (g_mk != null) {
                k_ci.f0 = personId;
                apv_ci.update_add(k_ci, g_mc.get_approximate() * g_mk.get_approximate());
                k_an.f0 = personId;
                Tuple1 g_an = apv_an.get(k_an);
                if (g_an != null) {
                    result += g_an.get_annotation() * g_mc.get_approximate() * g_mk.get_approximate();
                }
            }
        }
    }
        ...
        if (d_mc != 0) {
            ...
            if (g_mk != null) {
                ...
                while (f_ci != null) {
                    ...
                    apv_ci.update_add(k_ci, f_ci.object.get_annotation() * d_mc * g_mk.get_approximate());
                    k_an.f0 = f_ci.object.f0;
                    Tuple1 g_an = apv_an.get(k_an);
                    if (g_an != null) {
                        result += g_an.get_annotation() * f_ci.object.get_annotation() * d_mc * g_mk.get_approximate();
                    }
                    f_ci = f_ci.next;
                }
            }
    ...
    public void insert_into_movie_keyword(int id, int movieId) {
        ...
        if (d_mk != 0) {
            ...
            if (g_mc != null) {
                ...
                while (f_ci != null) {
                    k_ci.f0 = f_ci.object.f0;
                    apv_ci.update_add(k_ci, f_ci.object.get_annotation() * g_mc.get_approximate() * d_mk);
                    k_an.f0 = f_ci.object.f0;
                    Tuple1 g_an = apv_an.get(k_an);
                    if (g_an != null) {
                        result += g_an.get_annotation() * f_ci.object.get_annotation() * g_mc.get_approximate() * d_mk;
                    }
                    f_ci = f_ci.next;
                }
            }
