...
public class DynaGoxLine5cd extends DynaGoxLine5 {
    double result = 0;

    public DynaGoxLine5cd(double epsilon, boolean print) {
    ...
    public void insert_into_r4(int src, int dst) {
        ...
        if (g_r5 != null) {
            k_r4.f0 = src;
            double d_r4 = apv_r4.update_add_approx(k_r4, 1, b);
            if (d_r4 != 0) {
                t_r3.f1 = src;
    ...
    public void insert_into_r5(int src, int dst) {
        k_r5.f0 = src;
        boolean d_r5 = apv_r5.update_activate(k_r5);
        if (d_r5) {
