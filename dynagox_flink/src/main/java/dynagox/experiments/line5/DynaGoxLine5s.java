...
public class DynaGoxLine5s extends DynaGoxLine5 {
    double result = 0;

    public DynaGoxLine5s(double epsilon, boolean print) {
    ...
    public void insert_into_r1(int src, int dst) {
        k_r1.f0 = dst;
        double d_r1 = apv_r1.update_add_approx(k_r1, src, b);
        if (d_r1 != 0) {
            t_r2.f0 = dst;
            ...
            while (f_r2 != null) {
                ...
                if (g_r3 != null) {
                    result += d_r1 * g_r3.get_annotation();
                }
                f_r2 = f_r2.next;
            }
        }
    ...
    public void insert_into_r2(int src, int dst) {
        ...
        if (g_r1 != null) {
            ...
            Tuple1 g_r3 = apv_r3.get(k_r3);
            if (g_r3 != null) {
                result += g_r1.get_approximate() * g_r3.get_annotation();
            }
        }
    }
    ...
    public void insert_into_r3(int src, int dst) {
        ...
        if (g_r4 != null) {
            k_r3.f0 = src;
            apv_r3.update_add(k_r3, g_r4.get_approximate());
            k_r2.f0 = src;
            Tuple1 g_r2 = apv_r2.get(k_r2);
            if (g_r2 != null) {
                result += g_r2.get_annotation() * g_r4.get_approximate();
            }
        }
    }
    ...
    public void insert_into_r4(int src, int dst) {
        ...
        if (g_r5 != null) {
            k_r4.f0 = src;
            double d_r4 = apv_r4.update_add_approx(k_r4, g_r5.get_approximate(), b);
            if (d_r4 != 0) {
                t_r3.f1 = src;
                LinkedListNode<Tuple2> f_r3 = r_r3.find(0, t_r3);
                while (f_r3 != null) {
                    k_r3.f0 = f_r3.object.f0;
                    apv_r3.update_add(k_r3, d_r4);
                    k_r2.f0 = f_r3.object.f0;
                    Tuple1 g_r2 = apv_r2.get(k_r2);
                    if (g_r2 != null) {
                        result += g_r2.get_annotation() * d_r4;
                    }
                    f_r3 = f_r3.next;
                }
            }
    ...
    public void insert_into_r5(int src, int dst) {
        k_r5.f0 = src;
        double d_r5 = apv_r5.update_add_approx(k_r5, dst, b);
        if (d_r5 != 0) {
            ...
            while (f_r4 != null) {
                ...
                double d_r4 = apv_r4.update_add_approx(k_r4, d_r5, b);
                if (d_r4 != 0) {
                    d_r4s.update_add(k_r4, d_r4);
                }
                f_r4 = f_r4.next;
            }
            ...
            while (gk_r4 != null) {
                ...
                while (f_r3 != null) {
                    k_r3.f0 = f_r3.object.f0;
                    apv_r3.update_add(k_r3, gk_r4.get_annotation());
                    k_r2.f0 = f_r3.object.f0;
                    Tuple1 g_r2 = apv_r2.get(k_r2);
                    if (g_r2 != null) {
                        result += g_r2.get_annotation() * gk_r4.get_annotation();
                    }
                    f_r3 = f_r3.next;
                }
    ...
    public void delete_from_r1(int src, int dst) {
        k_r1.f0 = dst;
        double d_r1 = apv_r1.update_subtract_approx(k_r1, src, b);
        if (d_r1 != 0) {
            t_r2.f0 = dst;
            LinkedListNode<Tuple2> f_r2 = r_r2.find(0, t_r2);
            while (f_r2 != null) {
                k_r2.f0 = f_r2.object.f1;
                apv_r2.update_subtract(k_r2, d_r1);
                k_r3.f0 = f_r2.object.f1;
                Tuple1 g_r3 = apv_r3.get(k_r3);
                if (g_r3 != null) {
                    result -= d_r1 * g_r3.get_annotation();
    ...
    public void delete_from_r2(int src, int dst) {
        t_r2.f0 = src;
        t_r2.f1 = dst;
        r_r2.update_subtract(t_r2, 1);
        k_r1.f0 = src;
        Tuple1 g_r1 = apv_r1.get(k_r1);
        if (g_r1 != null) {
            k_r2.f0 = dst;
            apv_r2.update_subtract(k_r2, g_r1.get_approximate());
            k_r3.f0 = dst;
            Tuple1 g_r3 = apv_r3.get(k_r3);
            if (g_r3 != null) {
                result -= g_r1.get_approximate() * g_r3.get_annotation();
    ...
    public void delete_from_r3(int src, int dst) {
        t_r3.f0 = src;
        t_r3.f1 = dst;
        r_r3.update_subtract(t_r3, 1);
        k_r4.f0 = dst;
        Tuple1 g_r4 = apv_r4.get(k_r4);
        if (g_r4 != null) {
            k_r3.f0 = src;
            apv_r3.update_subtract(k_r3, g_r4.get_approximate());
            k_r2.f0 = src;
            Tuple1 g_r2 = apv_r2.get(k_r2);
            if (g_r2 != null) {
                result -= g_r2.get_annotation() * g_r4.get_approximate();
    ...
    public void delete_from_r4(int src, int dst) {
        t_r4.f0 = src;
        t_r4.f1 = dst;
        r_r4.update_subtract(t_r4, 1);
        k_r5.f0 = dst;
        Tuple1 g_r5 = apv_r5.get(k_r5);
        if (g_r5 != null) {
            k_r4.f0 = src;
            double d_r4 = apv_r4.update_subtract_approx(k_r4, g_r5.get_approximate(), b);
            if (d_r4 != 0) {
                t_r3.f1 = src;
                LinkedListNode<Tuple2> f_r3 = r_r3.find(0, t_r3);
                while (f_r3 != null) {
                    k_r3.f0 = f_r3.object.f0;
                    apv_r3.update_subtract(k_r3, d_r4);
                    k_r2.f0 = f_r3.object.f0;
                    Tuple1 g_r2 = apv_r2.get(k_r2);
                    if (g_r2 != null) {
                        result -= g_r2.get_annotation() * d_r4;
    ...
    public void delete_from_r5(int src, int dst) {
        k_r5.f0 = src;
        double d_r5 = apv_r5.update_subtract_approx(k_r5, dst, b);
        if (d_r5 != 0) {
            MultiHashMap<Tuple1> d_r4s = new MultiHashMap<>(
                    new PrimaryHashIndex<>(new Tuple1.Hash(), new Tuple1.Equal()), List.of());
            t_r4.f1 = src;
            ...
            while (f_r4 != null) {
                k_r4.f0 = f_r4.object.f0;
                double d_r4 = apv_r4.update_subtract_approx(k_r4, d_r5, b);
                if (d_r4 != 0) {
                    d_r4s.update_add(k_r4, d_r4);
                }
                f_r4 = f_r4.next;
            ...
            while (gk_r4 != null) {
                ...
                while (f_r3 != null) {
                    k_r3.f0 = f_r3.object.f0;
                    apv_r3.update_subtract(k_r3, gk_r4.get_annotation());
                    k_r2.f0 = f_r3.object.f0;
                    Tuple1 g_r2 = apv_r2.get(k_r2);
                    if (g_r2 != null) {
                        result -= g_r2.get_annotation() * gk_r4.get_annotation();
