...
public class TPCH3Orders implements MultiHashMapKey {
    ...
    private TPCH3Orders previous;
    private TPCH3Orders next;
    ...
    public void set_previous(MultiHashMapKey previous) {
        this.previous = (TPCH3Orders) previous;
    }

    @Override
    public MultiHashMapKey copy() {
        TPCH3Orders result = new TPCH3Orders();
    ...
    public static class Hash0 implements HashFunction<TPCH3Orders> {
        @Override
        public int hash(TPCH3Orders key) {
            return (key.o_orderkey + 0x9e3779b9);
        }
    }

    public static class Equal0 implements EqualFunction<TPCH3Orders> {
        @Override
        public boolean equal(TPCH3Orders a, TPCH3Orders b) {
            return a.o_orderkey == b.o_orderkey;
        }
    }

    public static class Hash1 implements HashFunction<TPCH3Orders> {
        @Override
        public int hash(TPCH3Orders key) {
    ...
    public static class Equal1 implements EqualFunction<TPCH3Orders> {
        @Override
        public boolean equal(TPCH3Orders a, TPCH3Orders b) {
