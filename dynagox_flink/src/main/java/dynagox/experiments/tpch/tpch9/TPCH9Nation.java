...
public class TPCH9Nation implements MultiHashMapKey {
    public int n_nationkey;
    public String n_name;
    private double annotation;
    private double approximate;
    private boolean active;
    private TPCH9Nation previous;
    private TPCH9Nation next;
    ...
    public void set_previous(MultiHashMapKey previous) {
        this.previous = (TPCH9Nation) previous;
    }

    @Override
    public MultiHashMapKey copy() {
        TPCH9Nation result = new TPCH9Nation();
    ...
    public static class Hash implements HashFunction<TPCH9Nation> {
        @Override
        public int hash(TPCH9Nation key) {
            return (key.n_nationkey + 0x9e3779b9);
        }
    }

    public static class Equal implements EqualFunction<TPCH9Nation> {
        @Override
        public boolean equal(TPCH9Nation a, TPCH9Nation b) {
