...
public class TPCH5Lineitem implements MultiHashMapKey {
    ...
    private TPCH5Lineitem previous;
    private TPCH5Lineitem next;

    public TPCH5Lineitem() {
        this.l_orderkey = 0;
        this.l_suppkey = 0;
        this.l_linenumber = 0;
    ...
    public void set_previous(MultiHashMapKey previous) {
        this.previous = (TPCH5Lineitem) previous;
    }

    @Override
    public MultiHashMapKey copy() {
        TPCH5Lineitem result = new TPCH5Lineitem();
    ...
    public static class Hash implements HashFunction<TPCH5Lineitem> {
        @Override
        public int hash(TPCH5Lineitem key) {
    ...
    public static class Equal implements EqualFunction<TPCH5Lineitem> {
        @Override
        public boolean equal(TPCH5Lineitem a, TPCH5Lineitem b) {
            return a.l_orderkey == b.l_orderkey && a.l_linenumber == b.l_linenumber;
        }
    }

    public static class Hash0 implements HashFunction<TPCH5Lineitem> {
        @Override
        public int hash(TPCH5Lineitem key) {
    ...
    public static class Equal0 implements EqualFunction<TPCH5Lineitem> {
        @Override
        public boolean equal(TPCH5Lineitem a, TPCH5Lineitem b) {
    ...
    public static class Hash1 implements HashFunction<TPCH5Lineitem> {
        @Override
        public int hash(TPCH5Lineitem key) {
    ...
    public static class Equal1 implements EqualFunction<TPCH5Lineitem> {
        @Override
        public boolean equal(TPCH5Lineitem a, TPCH5Lineitem b) {
