...
public class TPCH10OrdersJoinKey implements MultiHashMapKey {
    ...
    private TPCH10OrdersJoinKey previous;
    private TPCH10OrdersJoinKey next;

    public TPCH10OrdersJoinKey() {
        this.o_orderkey = 0;
        this.c_custkey = 0;
        this.c_name = "";
        this.c_address = "";
    ...
    public void set_next(MultiHashMapKey next) {
        this.next = (TPCH10OrdersJoinKey) next;
    }
    ...
    public void set_previous(MultiHashMapKey previous) {
        this.previous = (TPCH10OrdersJoinKey) previous;
    }

    @Override
    public MultiHashMapKey copy() {
        TPCH10OrdersJoinKey result = new TPCH10OrdersJoinKey();
    ...
    public static class Hash implements HashFunction<TPCH10OrdersJoinKey> {
        @Override
        public int hash(TPCH10OrdersJoinKey key) {
            return (key.o_orderkey + 0x9e3779b9);
        }
    }

    public static class Equal implements EqualFunction<TPCH10OrdersJoinKey> {
        @Override
        public boolean equal(TPCH10OrdersJoinKey a, TPCH10OrdersJoinKey b) {
