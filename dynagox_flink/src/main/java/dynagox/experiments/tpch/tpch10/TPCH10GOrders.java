...
public class TPCH10GOrders implements MultiHashMapKey {
    ...
    private TPCH10GOrders previous;
    private TPCH10GOrders next;

    public TPCH10GOrders() {
        this.c_custkey = 0;
        this.c_name = "";
        this.c_address = "";
        this.c_phone = "";
    ...
    public void set_previous(MultiHashMapKey previous) {
        this.previous = (TPCH10GOrders) previous;
    }

    @Override
    public MultiHashMapKey copy() {
        TPCH10GOrders result = new TPCH10GOrders();
    ...
    public static class Hash implements HashFunction<TPCH10GOrders> {
        @Override
        public int hash(TPCH10GOrders key) {
            return (key.c_custkey + 0x9e3779b9);
        }
    }

    public static class Equal implements EqualFunction<TPCH10GOrders> {
        @Override
        public boolean equal(TPCH10GOrders a, TPCH10GOrders b) {
