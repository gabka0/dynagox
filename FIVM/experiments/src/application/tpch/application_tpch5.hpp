    ...
    while (getline(in, line)) {
        if (line.at(0) == '*') {
            ...
            if (relation_id == 1) {
                ...
                getline(stream, field, '|');
                STRING_TYPE s_name = STRING_TYPE(field);
                getline(stream, field, '|');
                STRING_TYPE s_address = STRING_TYPE(field);
                getline(stream, field, '|');
                int s_nationkey = std::stoi(field);
                getline(stream, field, '|');
                STRING_TYPE s_phone = STRING_TYPE(field);
                getline(stream, field, '|');
                double s_acctbal = std::stod(field);
                getline(stream, field, '|');
                STRING_TYPE s_comment = STRING_TYPE(field);
                ...
                getline(stream, field, '|');
                STRING_TYPE r_name = STRING_TYPE(field);
                getline(stream, field, '|');
                STRING_TYPE r_comment = STRING_TYPE(field);
